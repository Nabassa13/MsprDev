...
public class templateHtml {
    ...
    public static String buildAgentHtml(agents agent, String contenu){
        ...
        concatenes.append("<!DOCTYPE html><html><head><meta charset=\"utf-8\" /><link rel=\"stylesheet\" href=\"..\\css\\style.css\"/><title>Agent ").append(agent.getPrenom()).append("</title></head><body><br><br><br><br><br><br><h2> Agent : ").append(agent.getPrenom()).append(" ").append(agent.getNom()).append(" </h2><br><br><img class=\"photoId\" src=\"").append(agent.getpathPhotoID()).append("\"  alt=\"Piece d\'identité de ").append(agent.getPrenom()).append(" ").append(agent.getNom()).append("\" /><br><br>").append(contenu).append("<a href=\"..\\..\\index.html\"><img class=\"logoSociete\" src=\"..\\..\\logo\\logo.png\", alt=\"Le logo de la société\"></a></div><div class=boutonRetour><a href=\"..\\..\\index.html\"> <img src= \"..\\..\\logo\\logoRetour.png\", alt=\"Logo retour\"> </a></div><footer><a href=\"..\\..\\index.html\">Accueil</a><br><br><a href=\"mailto:bastien.jarre@epsi.fr\"> Nous contacter </a><br><br><a href=\"..\\..\\mentionsLegales.html\"> Mentions légales </a></footer></body></html>");
